...
class ChangePasswordFullPage extends GetView<ChangePasswordFullController> {
  const ChangePasswordFullPage({
    super.key,
  });

  final String routes = "/CHANGE_PASSWORD_FULL_SCREEN";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ChangePasswordFullController>(
        init: ChangePasswordFullController(),
        builder: (controller) => SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 20),
            child: Form(
              key: controller.formKeyChangePassFull,
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    validator: (value) => Validate()
                        .rePassword(value, controller.passwordNew.text),
  ...
  void _changesPassword(ChangePasswordFullController controller) {
    var validate = controller.formKeyChangePassFull.currentState!.validate();

    if (!validate) {
      controller.changeFullPassword(
